...
QT_MOC_LITERAL(1, 12, 15), // "modified_signal"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 9), // "heightMap"
QT_MOC_LITERAL(4, 39, 7), // "setDraw"
QT_MOC_LITERAL(5, 47, 13) // "setDrawSquare"

    },
    "PaintWidget\0modified_signal\0\0heightMap\0"
    "setDraw\0setDrawSquare"
};
...
void PaintWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->modified_signal((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 1: _t->setDraw(); break;
        case 2: _t->setDrawSquare(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PaintWidget::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PaintWidget::modified_signal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PaintWidget::modified_signal(QImage _t1)
{
