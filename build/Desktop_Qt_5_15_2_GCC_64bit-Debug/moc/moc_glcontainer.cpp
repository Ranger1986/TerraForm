...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GLContainer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GLContainer_t qt_meta_stringdata_GLContainer = {
    {
QT_MOC_LITERAL(0, 0, 11) // "GLContainer"
...
QT_INIT_METAOBJECT const QMetaObject GLContainer::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_GLContainer.data,
    qt_meta_data_GLContainer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GLContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GLContainer.stringdata0))
